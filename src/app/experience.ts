...
export const EXPERIENCE: Experience[] = [
  {
    ...
    description: [
      ...
      'Auditing IT infrastructure for local companies and recommending improvements for their IT models.'
    ]
  },
  {
    title: 'IT Manager',
    ...
    description: [
      ...
      'Implement software and hardware update and maintenance schedules.',
      'Assign duties, responsibilities, and projects to the IT team, while providing training and mentorship.',
      'Oversee technical installation of equipment for five warehouses and ten storefronts.',
      'Meet regularly with owners, investors,  and the Board of Directors to plan strategic direction for the company.',
      'Planned the IT infrastructure for four new stores and two warehouses.'
    ]
  },
  {
    title: 'IT Supervisor',
    ...
    description: [
      ...
      'Oversee projects to design and implement local IT infrastructure, POS terminals, network systems, and servers.',
      'Assign schedules, coordinate staff and allocate resources to ensure efficiency and productivity are maximized.',
      'Manage G-suite policies and services for a medium sized business.',
      'Train end users on correct use of equipment and software.'
    ]
  },
  {
    ...
    description: [
      ...
      'Maintain, upgrade, and troubleshoot network equipment, P.O.S. terminals, security systems, and office hardware.',
      'Monitor security systems and remote security servers for five warehouses and ten storefronts.',
    ]
  }
];
